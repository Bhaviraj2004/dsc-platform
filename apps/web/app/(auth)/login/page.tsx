      ...
      <div className="hidden lg:flex flex-col justify-between p-12 bg-zinc-50 border-r border-zinc-100">
        ...
        <div>
          ...
          <p className="text-sm text-zinc-500 leading-relaxed max-w-sm mb-10">
            A modern platform for CAs to track DSC tokens,
            file returns, and manage client documents — securely.
          </p>

          <div className="space-y-4">
            {[
              { icon: '🔐', title: 'DSC Token Tracking', desc: 'Expiry alerts & renewal reminders' },
              { icon: '📋', title: 'Filing History', desc: 'ITR, GST, TDS, ROC — all in one place' },
              { icon: '✍️', title: 'Remote Signing', desc: 'Clients sign documents from anywhere' },
            ].map((f) => (
          ...
          <Card className="border-zinc-100 shadow-sm">
            ...
            <CardContent>
              ...
              <div className="bg-zinc-50 border border-zinc-200 rounded-lg p-3.5 text-xs text-zinc-500 mb-4 leading-relaxed">
                <span className="font-semibold text-zinc-800 block mb-1">🔑 Client Login Details</span>
                Clients can sign in using <code className="bg-zinc-200 px-1 py-0.5 rounded font-mono text-zinc-700 font-semibold">pan@dsc.com</code> (e.g. <code className="bg-zinc-200 px-1 py-0.5 rounded font-mono text-zinc-700 font-semibold">abcde1234f@dsc.com</code>) and their <code className="bg-zinc-200 px-1 py-0.5 rounded font-mono text-zinc-700 font-semibold">PAN Number</code> in uppercase as the password.
              </div>
              ...
              <p className="text-center text-xs text-zinc-400 mt-4">
                ...
                <a href="/register" className="text-zinc-700 font-semibold hover:text-zinc-900 transition-colors">
                  Create one
                </a>
              </p>
            </CardContent>
